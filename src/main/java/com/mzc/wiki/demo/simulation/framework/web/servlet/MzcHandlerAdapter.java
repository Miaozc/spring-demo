 ...
 */
public class MzcHandlerAdapter {
    public boolean supports(Object handler) {
        return (handler instanceof MzcHandlerMapping);
    }

    public MzcModelAndView handle(HttpServletRequest req, HttpServletResponse resp, Object handler)
            throws Exception {
        MzcHandlerMapping handlerMapping = (MzcHandlerMapping) handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() ==
                MzcModelAndView.class;
        if (isModelAndView) {
            return (MzcModelAndView) result;
        } else {
            return null;
        }
    }
